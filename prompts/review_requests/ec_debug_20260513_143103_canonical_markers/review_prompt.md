...
Please inspect the attached contact sheet image: `plots_contact_sheet_ec_debug_20260513_143103_canonical_markers.png`.
...
- Use canonical panels as supporting evidence, not automatic labels.
- Prefer broad labels unless marker evidence is strong and specific.
- Flag mixed, tiny, low-quality, or conflicting clusters as uncertain.
- Do not infer disease, condition, phenotype, or treatment effects.
...
- highly variable genes: `not available`
- raw present: `False`
- X_pca present: `False`
- X_pca shape: `not available`
- X_pca_harmony present: `False`
- X_pca_harmony shape: `not available`
- X_umap present: `False`
- X_umap shape: `not available`
- Leiden key present: `False`
- obsm keys: 
- layers: 
...
## Figure Summary
Review the attached contact sheet: `plots_contact_sheet_ec_debug_20260513_143103_canonical_markers.png`
